...
using SistemaChequesNuevo.Data.Migrations;
...
namespace SistemaChequesNuevo.Controllers
{
    ...
    public class ProveedorsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
           ...
           ViewBag.CuentaContableDescription = cuentasContablesList.FirstOrDefault(x => Convert.ToInt32(x.Value) == proveedor.CuentaContable).Text;
